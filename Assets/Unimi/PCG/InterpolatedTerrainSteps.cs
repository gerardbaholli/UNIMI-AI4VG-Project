...
public class InterpolatedTerrainSteps : MonoBehaviour {
	...
	public enum Steps { Samples, OneWay, Full };

	public Interpolations interpolator = Interpolations.Flat;
	public int subsampling = 10;
	public Steps StepToStop = Steps.Full;
	private static Steps step = Steps.Full;
	...
	private static float [,] BilinearInterpolator (int x, int y, int subsampling) {
		...
		if (step == Steps.Samples) return h;
